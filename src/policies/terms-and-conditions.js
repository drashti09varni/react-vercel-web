      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-5 bg-[#f8f8f8] rounded-[24px] p-7 shadow-sm">
          ...
          <ul className="mt-6 space-y-4 text-[#263246] text-[16px] leading-8 list-disc pl-6">
            ...
            <li>
              Product prices, offers, stock availability,
              and final payable amounts are shown before checkout.
            </li>

            <li>
              Orders are subject to payment verification,
              serviceability, and successful confirmation.
            </li>

            <li>
              Shipping, cancellation, return, refund,
              and payment policies are explained in
              the linked policy pages available on the website.
            </li>

            <li>
              Customers must provide accurate name,
              mobile number, shipping address,
              and payment details where required.
            </li>

            <li>
              Misuse of the website, fraudulent activity,
              or abuse of offers may result in order cancellation.
            </li>

            <li>
              For order or policy-related questions,
              contact support@trendvero.shop.
            </li>
